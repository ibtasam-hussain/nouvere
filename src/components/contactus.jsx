    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div 
          ...
          style={{
            borderStyle: 'solid',
            borderWidth: '0 0 150px 200px',
            borderColor: 'transparent transparent #6d28d9 transparent'
          }}
        ></div>
      ...
      <div className="relative z-10 w-full max-w-5xl">
        <div 
          className="bg-black/40 backdrop-blur-sm rounded-3xl p-8 lg:p-12"
          style={{
