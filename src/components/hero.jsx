...
import hoverBird from "../assets/hoverBird.svg"; // <- your hover image
...
const Hero = () => {
  ...
  return (
    <section className="relative w-full h-screen flex items-center overflow-hidden">
      ...
      {/* Main Content */}
      <div className="relative z-30 flex items-center justify-between w-full px-4 sm:px-6 md:px-8 lg:px-12">
        {/* Content on the left */}
        <div className="flex flex-col items-start max-w-xs sm:max-w-sm md:max-w-md lg:max-w-2xl">
      ...
      {/* Bottom right text */}
      <div className="absolute bottom-6 sm:bottom-8 md:bottom-12 right-4 sm:right-6 md:right-8 lg:right-12 text-right z-30">
